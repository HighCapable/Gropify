...
/**
 * Compile specification for generated Java source files.
 */
internal interface CodeCompileSpec {

    /** Whether there is no source file to compile. */
    val isEmpty: Boolean

    /**
     * Compile source files as a dependency.
     * @param dependency the dependency entity.
     * @param outputDirPath the compile output directory path.
     */
    fun compile(dependency: Dependency, outputDirPath: String)
}